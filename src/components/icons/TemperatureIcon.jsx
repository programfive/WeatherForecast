export function TemperatureIcon(props) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <rect x="20" y="4" width="7" height="2"></rect>
      <rect x="20" y="10" width="10" height="2"></rect>
      <rect x="20" y="16" width="7" height="2"></rect>
      <path d="M12,23a3,3,0,0,1-6,0Z" transform="translate(0 0)"></path>
      <path
